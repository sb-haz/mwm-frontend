...
export default async function CouplePageDashboard() {
    ...
    return (
        <div>
            {/* Top Art */}
            <Image src="flower-art-top-2.png" className="image-full-width" width={375} height={117} alt="" />

            <div className="container reduce-container-margin">
                {/* Image Above Boxes */}
                <div className="dashboard-image-above-boxes grow-effect">
                    <Image src="couples-name.png" width={223} height={42} alt="" />
                </div>
                ...
                <div className="dashboard-box-container">
                    ...
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        ...
                        <Image className="dashboard-icon" src="dash-1.png" alt="" />
                    </div>

                    {/* Dashboard Box 2 */}
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        <h2 className="heading-medium">Send Videos</h2>
                        <Image className="dashboard-icon" src="dash-2.png" alt="" />
                    </div>

                    {/* Dashboard Box 3 */}
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        <h2 className="heading-medium">Gifting</h2>
                        <Image className="dashboard-icon" src="dash-3.png" alt="" />
                    </div>

                    {/* Dashboard Box 4 */}
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        <h2 className="heading-medium">Quiz</h2>
                        <Image className="dashboard-icon" src="dash-4.png" alt="" />
                    </div>

                    {/* Dashboard Box 5 */}
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        <h2 className="heading-medium">Event</h2>
                        <Image className="dashboard-icon" src="dash-5.png" alt="" />
                    </div>

                    {/* Dashboard Box 6 */}
                    <div className="dashboard-box live-dashboard box-drop-shadow-03">
                        <h2 className="heading-medium">Chat</h2>
                        <Image className="dashboard-icon" src="dash-6.png" alt="" />
                    </div>
                </div>
