...
export default async function Home() {
    return (
        <div>
            <img src="/flower-art-top-2.png" className="image-full-width top-banner-image" alt="Flower Art" width={375} height={117} />
            <div className="container">
                <div className="live-container">
                    <div className="center-items">
                        <img src="/home-couple.png" className="image-full-width home-couple-image margin-top-15" alt="Home Couple" width={625} height={373} />
                    ...
                    <div className="button-container margin-top-15">
                        <Link href="marketplace">
                            <div className="explore-app-div">
                                ...
                                <img src="/up-arrow-flipped.png" className="up-arrow-second" alt="Up Arrow Flipped" />
                            </div>
                        </Link>
                    </div>
                </div>
